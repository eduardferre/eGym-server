...
async def getRoutinesTO(token: str = Depends(oauth2_scheme)):
...
async def getRoutineTOById(id: str, token: str = Depends(oauth2_scheme)):
    if token_validation(token) != None:
...
async def getRoutinesTOByCreator(creator: str, token: str = Depends(oauth2_scheme)):
    if token_validation(token) != None:
...
async def getRoutinesTOByName(name: str, token: str = Depends(oauth2_scheme)):
    if token_validation(token) != None:
...
async def addRoutineTO(routineTO: RoutineTO, token: str = Depends(oauth2_scheme)):
    if token_validation(token) != None:
...
async def addExerciseTOToRoutineTO(routineId: str, exerciseId: str, token: str = Depends(oauth2_scheme)):
    if token_validation(token) != None:
...
async def updateRoutineTO(routineTO: RoutineTO, token: str = Depends(oauth2_scheme)):
    if token_validation(token) != None:
...
async def deleteRoutineTO(id: int, token: str = Depends(oauth2_scheme)):
    if token_validation(token) != None:
